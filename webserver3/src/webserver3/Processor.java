...
public class Processor extends Thread{
          ...
          public void close(){
        	  if(request.getValue("Connection").equals("close"))
        	  {
        	  try{
        		  socket.close();
        		  logger.info("\nsocket is closed!\n");
          ...
          public void analyzeFile(String filename){
          	  ...
          	  if(!file.exists()){ 
          		 showValue(filename.substring(3));
          ...
          public void showValue(String key){
        	  if(key.equals("Host")||key.equals("Connection")||key.equals("Accept")||key.equals("User-Agent")||key.equals("Accept-Encoding")||key.equals("Accept-Language")||key.equals("Cookie"))
        		 {
        		 response.setStatus(404);
           		 response.addHeader("Content-type", "text/html");
           		 response.addBody(dealError(request.getValue(key)));
           		 response.send();
        		 }
          }
}
